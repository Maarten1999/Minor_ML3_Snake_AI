...
class SnakeEnv(gym.Env):
    ...
    def __init__(self, grid_size=[15, 15], unit_size=10, unit_gap=1, snake_size=3, n_snakes=1, n_foods=1,
        ...
        self.action_space = spaces.Discrete(
            4)  # Erco: replaced Discrete(4) by spaces.Discrete(4); needed to use stable-baselines
    ...
    def reset(self):
        self.controller = Controller(self.grid_size, self.unit_size, self.unit_gap, self.snake_size, self.n_snakes,
                                     self.n_foods, random_init=self.random_init)
